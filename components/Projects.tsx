    ...
    >
      ...
      <div className="break-words xl:w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray/20 scrollbar-thumb-pink/80">
        {projects.map((project,index)=>(
          <div className="mt-9 md:mt-0 xl:mt-9 xl:w-screen flex-shrink-3 snap-center flex flex-col 
            ...
            px-0 md:px-10 xl:max-w-6xl max-w-sm">
              ...
              <p className='text-xs md:text-xl overflow-hidden'>This is a project promoted by GNUno, which consists of a set of 'study plans' of different technologies for someone who is just starting out has a path to follow, together with resources such as videos, tutorials and recommended bibliography, in addition to the support that the community can give in telegram groups.</p>
              <button>Link</button>
            </div>
          </div>
        ))}
