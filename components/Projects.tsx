...
export default function Projects({data}: Props) {
  ...
  return (
    ...
    >
      <h3 className="absolute top-10 md:top-16 uppercase lg:tracking-[20px] tracking-[15px] text-yellow xl:text-2xl text-xl font-press2p mx-auto w-full">Projects</h3>
              ...
              <div className="overflow-hidden">
                <Link href={project.link} target="_blank">
                  <Image
                    ...
                    width={600}
                    height={600}
                    className="rounded-xl xl:h-80 xl:w-[650px] h-52 w-72 object-cover cursor-pointer" alt="project image" />
                </Link>
              </div>
