...
export default function WorkExperience({data}: Props) {
  ...
  <motion.div
    ...
    className="h-screen overflow-hidden max-w-full mx-auto text-center">
      <h2 className="uppercase lg:tracking-[20px] tracking-[15px] text-yellow lg:text-2xl text-xl font-press2p mt-5 xl:mt-10">Experience</h2>
